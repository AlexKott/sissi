...
3. [Quick Start]
  ...
  iii. [Work on your site]
  iv. [Publish the static site]
...
* [sissi-packs] sets the stage for you, the developer. (Psst, 'packs' comes from [webpack](https://webpack.js.org/).)
...
`SissiLink` is a wrapper for the [ReactRouter Link](https://github.com/ReactTraining/react-router/blob/master/packages/react-router-dom/docs/api/Link.md) component and supports all its main features. To make it work simply import it from `sissi-guides` and use it in your jsx. The only thing you *have* to do is include a `to` attribute pointing to the desired route:
